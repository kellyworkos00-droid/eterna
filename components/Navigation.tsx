          ...
          <div className="flex items-center gap-2">
            ...
            {mainNavLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="flex flex-col items-center gap-0.5 text-eterna-accent hover:text-eterna-maroon transition-colors duration-300 px-3 py-2 rounded-xl hover:bg-eterna-maroon/20 group"
                title={link.label}
              >
                <div className="w-4 h-4 transform group-hover:scale-110 transition-transform duration-300">
                  {link.icon}
                </div>
            ...
            <Link
              href="/cart"
              className="relative flex flex-col items-center gap-0.5 text-eterna-accent hover:text-eterna-maroon transition-colors duration-300 px-3 py-2 rounded-xl hover:bg-eterna-maroon/20 group"
              title="Cart"
            >
              <div className="w-4 h-4 transform group-hover:scale-110 transition-transform duration-300">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {cartCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-eterna-maroon text-white text-[8px] rounded-full w-4 h-4 flex items-center justify-center font-bold shadow-lg">
                    {cartCount}
                  </span>
                )}
              </div>
